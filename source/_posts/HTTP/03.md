...
在正式展开之前，我们先来了解一下 `Performance` 接口，简单来说，它可以获取到当前页面中与性能相关的信息

<!--more-->

但是在这里就不详细展开了，具体的可以参考下面两篇文章，有个概念即可

[Performance](https://developer.mozilla.org/zh-CN/docs/Web/API/Performance)

[网页监控与程序性能](https://segmentfault.com/a/1190000003703174)
...
![](https://gitee.com/heptaluan/backups/raw/master/cdn/http/09.png)
...
![](https://gitee.com/heptaluan/backups/raw/master/cdn/http/10.png)
...
![](https://gitee.com/heptaluan/backups/raw/master/cdn/http/11.png)
...
![](https://gitee.com/heptaluan/backups/raw/master/cdn/http/12.png)
...
![](https://gitee.com/heptaluan/backups/raw/master/cdn/http/13.png)
...
![](https://gitee.com/heptaluan/backups/raw/master/cdn/http/14.png)
...
大致的了解了域名结构以后，我们就来正式的看一看所谓的 `DNS` 解析

其实简单来说，上面章节当中所描述的过程就是 `DNS` 解析的一个大致过程，即 **迭代解析**  一个完整的 `DNS` 解析过程如下（摘自 [域名收敛--前端优化](https://segmentfault.com/a/1190000004641599#articleHeader2)）
...
![](https://gitee.com/heptaluan/backups/raw/master/cdn/http/15.png)
...
![](https://gitee.com/heptaluan/backups/raw/master/cdn/http/16.png)
...
![](https://gitee.com/heptaluan/backups/raw/master/cdn/http/17.png)
...
![](https://gitee.com/heptaluan/backups/raw/master/cdn/http/18.png)
