...
本文主要参考 [CSS 伸缩盒布局模组](https://www.w3.org/html/ig/zh/css-flex-1/)，主要介绍的是应用在元素身上的 `flex` 属性取值的问题，关于 `flex` 布局的一些知识可以参考 [flex 布局](http://localhost:4000/2019/09/12/CSS/11/#flex-%E5%B8%83%E5%B1%80)，故本文不会涉及太多
