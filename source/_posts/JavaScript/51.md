...
| `Object.getOwnPropertyNames()` | 返回一个由指定对象的所有自身属性的属性名（包括不可枚举属性但不包括 `Symbol` 值作为名称的属性）组成的数组，详细可见 [Object.getOwnPropertyNames()](http://localhost:4000/2019/06/28/JavaScript/35/#Object-getOwnPropertyNames-obj) | - |
...
|方法|描述|兼容性（非特别指出表示兼容性良好）|
|-|-|-|
| `Object.prototype.hasOwnProperty()` | 返回一个布尔值，指示对象自身属性中是否具有指定的属性（也就是，是否有指定的键），见 [JavaScript 中的类型判断](http://localhost:4000/2018/03/17/JavaScript/25/#Object-prototype-hasOwnProperty) | - |
| `Object.prototype.toString()` | 返回一个表示该对象的字符串，见 [JavaScript 中的类型判断](http://localhost:4000/2018/03/17/JavaScript/25/#Object-prototype-toString) | - |
| `Object.prototype.isPrototypeOf()` | 用于测试一个对象是否存在于另一个对象的原型链上，见 [JavaScript 中的类型判断](http://localhost:4000/2018/03/17/JavaScript/25/#isPrototypeOf-NaN) | - |
