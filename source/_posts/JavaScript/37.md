...
这里我们就简单的梳理一下，至于更为详细的过程可以参考之前整理过的 [浏览器输入网址到页面展示所经历的过程](http://localhost:4000/2017/11/07/HTTP/01/) 和 [域名发散与收敛](http://localhost:4000/2017/12/01/HTTP/03/) 当中的相关内容，流程如下
