...
当然关于 `infer` 还有许多的「骚操作」，比如 `tuple` 转 `union`，`union` 转 `tuple` 等等，这里就不详细展开了，可以参考下面几个链接来了解更多

* [infer 的一些用例](https://jkchao.github.io/typescript-book-chinese/tips/infer.html#%E4%B8%80%E4%BA%9B%E7%94%A8%E4%BE%8B)
* [union to tuple](https://zhuanlan.zhihu.com/p/58704376)
