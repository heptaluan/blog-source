...
![](https://gitee.com/heptaluan/backups/raw/master/cdn/js/03.png)

例如 `Object` 的 `prototype` 上就挂载了一系列方法

![](https://gitee.com/heptaluan/backups/raw/master/cdn/js/04.png)
...
![](https://gitee.com/heptaluan/backups/raw/master/cdn/js/05.png)
