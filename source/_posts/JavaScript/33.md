...
tags: JavaScript
toc: true
thumbnail: https://gitee.com/heptaluan/backups/raw/master/cdn/cover/33.jpg
---
...
* 协议：网络协议遍及 `OSI` 通信模型（[OSI 七层模型](https://zh.wikipedia.org/wiki/OSI%E6%A8%A1%E5%9E%8B)，常用协议有 `TCP/IP`、`http`、`FTP` 协议等）
