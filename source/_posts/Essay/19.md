...
![](https://raw.githubusercontent.com/heptaluan/blog-backups/master/cdn/essay/19-03.png)
...
![](https://raw.githubusercontent.com/heptaluan/blog-backups/master/cdn/essay/19-06.png)

然后将它们的『根结点』依次连在一起

![](https://raw.githubusercontent.com/heptaluan/blog-backups/master/cdn/essay/19-07.png)
...
![](https://raw.githubusercontent.com/heptaluan/blog-backups/master/cdn/essay/19-09.png)

第一步，若结点 `x` 是其双亲 `y` 的左孩子，则把 `x` 的右孩子，右孩子的右孩子等等等等，依次都与 `y` 用连连连接起来，如下

![](https://raw.githubusercontent.com/heptaluan/blog-backups/master/cdn/essay/19-10.png)

第二步，去掉所有双亲到右孩子之间到连线（也就是之前到逆向）

![](https://raw.githubusercontent.com/heptaluan/blog-backups/master/cdn/essay/19-11.png)

最后老规矩，调整一下，就变成了我们之前的森林

![](https://raw.githubusercontent.com/heptaluan/blog-backups/master/cdn/essay/19-12.png)
...
![](https://raw.githubusercontent.com/heptaluan/blog-backups/master/cdn/essay/19-13.png)

如果按照上面这个流程，比如某个同学的成绩是 `85` 分的话，则需要进行三次判断才能得出他的成绩，那么我们是否可以稍微的调整一下，让这个判断流程减少一些呢，那就有了下图这样的二叉树

![](https://raw.githubusercontent.com/heptaluan/blog-backups/master/cdn/essay/19-14.png)

如果我们把判断流程改为像上图这样，那么可以发现效果有比较明显的改善，即我们只需要两次判断就可以得出我们想要的结果，但是我们如何区分到底应该采用哪种判断流程呢？所以这种情况要按实际情况来进行考虑，如下图

![](https://raw.githubusercontent.com/heptaluan/blog-backups/master/cdn/essay/19-15.png)
...
![](https://raw.githubusercontent.com/heptaluan/blog-backups/master/cdn/essay/19-16.png)
...
![](https://raw.githubusercontent.com/heptaluan/blog-backups/master/cdn/essay/19-17.png)
...
![](https://raw.githubusercontent.com/heptaluan/blog-backups/master/cdn/essay/19-18.png)

然后同理操作，继续在剩余树林当中挑选出权值最小的那一颗，按照我们之前的逻辑继续连接，也就是下面这样

![](https://raw.githubusercontent.com/heptaluan/blog-backups/master/cdn/essay/19-19.png)
