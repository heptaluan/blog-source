...
![](https://gitee.com/heptaluan/backups/raw/master/cdn/essay/119.png)
...
![](https://gitee.com/heptaluan/backups/raw/master/cdn/essay/120.png)

然后在去除**非长子外**的连线

![](https://gitee.com/heptaluan/backups/raw/master/cdn/essay/121.png)

最后，我们在稍微调整一下位置，就可以得出我们想要的二叉树

![](https://gitee.com/heptaluan/backups/raw/master/cdn/essay/122.png)
...
![](https://gitee.com/heptaluan/backups/raw/master/cdn/essay/123.png)
...
![](https://gitee.com/heptaluan/backups/raw/master/cdn/essay/124.png)

然后将它们的**根结点**依次连在一起

![](https://gitee.com/heptaluan/backups/raw/master/cdn/essay/125.png)

最后老规矩，在稍微调整一下位置

![](https://gitee.com/heptaluan/backups/raw/master/cdn/essay/126.png)
...
![](https://gitee.com/heptaluan/backups/raw/master/cdn/essay/127.png)

第二步，去掉所有双亲到右孩子之间到连线（也就是之前到逆向）

![](https://gitee.com/heptaluan/backups/raw/master/cdn/essay/128.png)

最后老规矩，调整一下，就变成了我们之前的森林

![](https://gitee.com/heptaluan/backups/raw/master/cdn/essay/129.png)
...
![](https://gitee.com/heptaluan/backups/raw/master/cdn/essay/130.png)

如果按照上面这个流程，比如某个同学的成绩是 `85` 分的话，则需要进行三次判断才能得出他的成绩

那么我们是否可以稍微的调整一下，让这个判断流程减少一些呢，那就有了下图这样的二叉树

![](https://gitee.com/heptaluan/backups/raw/master/cdn/essay/131.png)

如果我们把判断流程改为像上图这样，那么可以发现效果有比较明显的改善，即我们只需要两次判断就可以得出我们想要的结果

但是我们如何区分到底应该采用哪种判断流程呢？所以这种情况要按实际情况来进行考虑，如下图

![](https://gitee.com/heptaluan/backups/raw/master/cdn/essay/132.png)
...
![](https://gitee.com/heptaluan/backups/raw/master/cdn/essay/133.png)
...
![](https://gitee.com/heptaluan/backups/raw/master/cdn/essay/134.png)
...
![](https://gitee.com/heptaluan/backups/raw/master/cdn/essay/135.png)

然后同理操作，继续在剩余树林当中挑选出权值最小的那一颗，按照我们之前的逻辑继续连接，也就是下面这样

![](https://gitee.com/heptaluan/backups/raw/master/cdn/essay/136.png)

依次执行下去，最后的结果如下

![](https://gitee.com/heptaluan/backups/raw/master/cdn/essay/137.png)
...
下面我们来看看如何用代码进行实现，这里只采取 `JavaScript` 来进行实现（因为 `C` 的版本实在看不明白），我们首先来定义哈夫曼树节点 `HuffmanTreeNode`
