...
我们在 [查找算法](http://localhost:4000/2020/03/01/Essay/26/) 一节当中介绍了一些比较常用的算法，比如二分，插值等等，但是它们的使用都需要一个前提条件，那就是 **元素必须是有序的**
...
在之前的章节当中，我们曾经介绍过了 [二叉树的的定义](http://localhost:4000/2020/02/15/Essay/16/) 和 [二叉树的遍历](http://localhost:4000/2020/02/16/Essay/17/)
...
下面我们就来看看如何实现，代码如下，也就是在我们之前的 [二叉树](http://localhost:4000/2020/02/16/Essay/17/#%E4%BA%8C%E5%8F%89%E6%A0%91%E7%9A%84%E5%BB%BA%E7%AB%8B%E5%92%8C%E9%81%8D%E5%8E%86) 的基础上进行扩充
...
但是实际上这样的二叉查找树是存在一些问题的，针对我们之前的示例，当我们不断的添加更大或者更小的元素的时候，会出现如下情况
...
很容易发现，它是不平衡的，这又会引出平衡树的概念，这个问题我们会在后面的 **平衡二叉树** 当中来进行解决