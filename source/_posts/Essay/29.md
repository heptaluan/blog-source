...
![](https://raw.githubusercontent.com/heptaluan/blog-backups/master/cdn/essay/29-01.png)

又或者现在要统计的是 `1980` 年以后出生的人口数，那么我们也可以对出生年份这个关键字可以变换为用年份减去 `1980` 的值来作为地址，即 `f(key) = key – 1980`，也就是下面这样

![](https://raw.githubusercontent.com/heptaluan/blog-backups/master/cdn/essay/29-02.png)
...
![](https://raw.githubusercontent.com/heptaluan/blog-backups/master/cdn/essay/29-03.png)
...
![](https://raw.githubusercontent.com/heptaluan/blog-backups/master/cdn/essay/29-04.png)

但是 `p` 的选择是关键，如果对于这个表格的关键字，`p` 如果还是选择 `12` 的话，那就不是一个很好的方式了

![](https://raw.githubusercontent.com/heptaluan/blog-backups/master/cdn/essay/29-05.png)

不过针对上面这种情况，如果我们把 `p` 改为 `11` 也是可以的，如下

![](https://raw.githubusercontent.com/heptaluan/blog-backups/master/cdn/essay/29-06.png)
...
![](https://raw.githubusercontent.com/heptaluan/blog-backups/master/cdn/essay/29-07.png)

需要注意，此时我们需要添加元素 `37`，但是发现 `37 % 12 = 1` 的，而此时 `1` 的位置已经存在元素了，所以就发生了冲突，所以此时我们可以调用公式 `fi(key) = (f(1) + 1) MOD 12`，它的结果是 `2`，所以它填充在 `2` 的位置，也就下面这样

![](https://raw.githubusercontent.com/heptaluan/blog-backups/master/cdn/essay/29-08.png)

最终完成后是下面这样

![](https://raw.githubusercontent.com/heptaluan/blog-backups/master/cdn/essay/29-09.png)
...
![](https://raw.githubusercontent.com/heptaluan/blog-backups/master/cdn/essay/29-10.png)
...
![](https://raw.githubusercontent.com/heptaluan/blog-backups/master/cdn/essay/29-11.png)
...
![](https://raw.githubusercontent.com/heptaluan/blog-backups/master/cdn/essay/29-12.png)
