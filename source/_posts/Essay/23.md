...
本章我们主要来看两个最小生成树的算法，即 **普里姆算法** 和 **克鲁斯卡尔算法**，它们的目的都是生成 **最小生成树**
...
下面来看如何用代码实现，关于 [图的生成](https://heptaluan.github.io/2020/02/22/Essay/21/#%E9%82%BB%E6%8E%A5%E7%9F%A9%E9%98%B5%E7%9A%84%E5%AE%9E%E7%8E%B0) 可以见之前的章节，依然使用的是之前的代码，这里我们主要来看算法的实现
