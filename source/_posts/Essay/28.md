...
tags: Essay
toc: true
thumbnail: https://raw.githubusercontent.com/heptaluan/blog-backups/master/cdn/cover/28.webp
---
...
![](https://raw.githubusercontent.com/heptaluan/blog-backups/master/cdn/essay/28-01.png)

看上去还不错的样子，比如我们要查找 `9` 这个元素，两次对比后就可以得到结果，但是如果我们将序列调整为 `1, 2, 3, 4, 5, 6, 7, 8, 9`，那么它就成了下面这样的

![](https://raw.githubusercontent.com/heptaluan/blog-backups/master/cdn/essay/28-02.png)
...
![](https://raw.githubusercontent.com/heptaluan/blog-backups/master/cdn/essay/28-03.png)

而下面这个就不符合条件，因为平衡二叉排序树首先要是一棵树，接着需要是一颗二叉排序树，下面这个明显不符合二叉排序树的概念

![](https://raw.githubusercontent.com/heptaluan/blog-backups/master/cdn/essay/28-04.png)

在来看下面这个例子

![](https://raw.githubusercontent.com/heptaluan/blog-backups/master/cdn/essay/28-05.png)

它其实也不是平衡二叉排序树，因为比如结点 `9`，它的左子树和右子树的差的绝对值已经大于 `1` 了，再来看最后一个图

![](https://raw.githubusercontent.com/heptaluan/blog-backups/master/cdn/essay/28-06.png)
...
![](https://raw.githubusercontent.com/heptaluan/blog-backups/master/cdn/essay/28-07.png)

让我们抛开上图，一步一步从头开始进行操作，首先是根结点 `3`，和它的两个左子树元素 `2` 和 `1`，那么就会是下面这样的

![](https://raw.githubusercontent.com/heptaluan/blog-backups/master/cdn/essay/28-08.png)
...
![](https://raw.githubusercontent.com/heptaluan/blog-backups/master/cdn/essay/28-09.png)

下面我们在继续来进行添加，我们在依次插入结点 `4` 和 `5`，如下

![](https://raw.githubusercontent.com/heptaluan/blog-backups/master/cdn/essay/28-10.png)
...
![](https://raw.githubusercontent.com/heptaluan/blog-backups/master/cdn/essay/28-11.png)

下面我们继续操作，插入结点 `6`，变成了下面这样

![](https://raw.githubusercontent.com/heptaluan/blog-backups/master/cdn/essay/28-12.png)

这时可以发现，`4，5，6` 都是符合的，但是结点 `2` 却不符合了，所以我们此时需要调整结点 `2`，可以发现它的平衡因子是负数，所以左旋转，也就成了下面这样

![](https://raw.githubusercontent.com/heptaluan/blog-backups/master/cdn/essay/28-13.png)
...
![](https://raw.githubusercontent.com/heptaluan/blog-backups/master/cdn/essay/28-14.png)

下面继续插入结点 `7`，如下

![](https://raw.githubusercontent.com/heptaluan/blog-backups/master/cdn/essay/28-15.png)

老规矩，发现结点 `5` 的平衡因子为 `-2`，所以左转，就变成了下面这样

![](https://raw.githubusercontent.com/heptaluan/blog-backups/master/cdn/essay/28-16.png)

继续插入结点 `10` 和 `9`

![](https://raw.githubusercontent.com/heptaluan/blog-backups/master/cdn/essay/28-17.png)

又发现问题，结点 `9` 的插入导致了结点 `4，6，7` 的 `BF` 值均为 `-2`，但是这里注意，结点 `10` 的 `BF` 是为 `1` 的，所以这时如果按照我们之前的逻辑，负数向左旋转，我们可以尝试一下来调整结点 `7`，结果如下

![](https://raw.githubusercontent.com/heptaluan/blog-backups/master/cdn/essay/28-18.png)
...
![](https://raw.githubusercontent.com/heptaluan/blog-backups/master/cdn/essay/28-19.png)

此时的 `BF` 就全部为负了，我们在按照我们之前的逻辑来处理结点 `7`，也就是向左旋转，就得到了下面这样

![](https://raw.githubusercontent.com/heptaluan/blog-backups/master/cdn/essay/28-20.png)

这时发现就是平衡的了，所以可以再次插入我们最后的结点 `8`，如下

![](https://raw.githubusercontent.com/heptaluan/blog-backups/master/cdn/essay/28-21.png)
...
![](https://raw.githubusercontent.com/heptaluan/blog-backups/master/cdn/essay/28-22.png)
...
![](https://raw.githubusercontent.com/heptaluan/blog-backups/master/cdn/essay/28-23.png)
...
![](https://raw.githubusercontent.com/heptaluan/blog-backups/master/cdn/essay/28-24.png)
...
![](https://raw.githubusercontent.com/heptaluan/blog-backups/master/cdn/essay/28-25.png)
...
![](https://raw.githubusercontent.com/heptaluan/blog-backups/master/cdn/essay/28-26.png)
