...
![](https://raw.githubusercontent.com/heptaluan/blog-backups/master/cdn/essay/12-01.png)
...
![](https://raw.githubusercontent.com/heptaluan/blog-backups/master/cdn/essay/12-02.png)

当队列为空时，`front` 和 `rear` 都指向头结点

![](https://raw.githubusercontent.com/heptaluan/blog-backups/master/cdn/essay/12-03.png)
...
![](https://raw.githubusercontent.com/heptaluan/blog-backups/master/cdn/essay/12-04.png)

![](https://raw.githubusercontent.com/heptaluan/blog-backups/master/cdn/essay/12-05.png)

![](https://raw.githubusercontent.com/heptaluan/blog-backups/master/cdn/essay/12-06.png)
...
![](https://raw.githubusercontent.com/heptaluan/blog-backups/master/cdn/essay/12-07.png)

![](https://raw.githubusercontent.com/heptaluan/blog-backups/master/cdn/essay/12-08.png)

但是这里有一个需要注意的地方，就是如果原队列只有一个元素，那么我们就应该处理一下队尾指针

![](https://raw.githubusercontent.com/heptaluan/blog-backups/master/cdn/essay/12-09.png)

![](https://raw.githubusercontent.com/heptaluan/blog-backups/master/cdn/essay/12-10.png)
...
![](https://raw.githubusercontent.com/heptaluan/blog-backups/master/cdn/essay/12-11.png)

入队列操作其实就是在队尾追加一个元素，不需要任何移动，时间复杂度为 `O(1)`，而出队列则不同，因为我们已经假设下标为 `0` 的位置是队列的队头，因此每次出队列操作所有元素都要向前移动，所以当前的时间复杂度为 `O(n)`

![](https://raw.githubusercontent.com/heptaluan/blog-backups/master/cdn/essay/12-12.png)

但是这里我们可以想到，如果我们不去限制队头一定要在下标为 `0` 的位置，那么出队列的操作就是不是不需要移动全体元素了呢？看下面这个图

![](https://raw.githubusercontent.com/heptaluan/blog-backups/master/cdn/essay/12-13.png)

但是这样也会出现一些问题，例如按下边的情形继续入队列，就会出现数组越界的错误

![](https://raw.githubusercontent.com/heptaluan/blog-backups/master/cdn/essay/12-14.png)
...
![](https://raw.githubusercontent.com/heptaluan/blog-backups/master/cdn/essay/12-15.png)
