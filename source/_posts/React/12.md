...
![](https://raw.githubusercontent.com/heptaluan/blog-backups/master/cdn/react/12-01.png)

我们很难把控每一根指向 `appState` 的箭头，`appState` 里面的东西就无法把控，但现在我们必须通过一个中间人（`dispatch`），所有的数据修改必须通过它

![](https://raw.githubusercontent.com/heptaluan/blog-backups/master/cdn/react/12-02.png)
